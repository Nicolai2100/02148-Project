...
public class StockStream {
    ...
    /**
     * Simple method to return a random stock generated by the stream.
     * @return
     */
    public String getRandomStockRecommandation() {
        try {
            return (String) (finishedEvaluatedStockSpace.get(new FormalField(String.class))[0]);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        return "couldn't find a stock";
    }
