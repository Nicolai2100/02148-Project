...
public class LockService {
    ...
    /**
     * The lock service is designed to keep efficency tip top. It creates locks for each stock that each locks a small
     * part of the buy/sell orders in the stock. It also keeps track of which number the next entry into a stock should be,
     * and helps the broker with providing numbers for new keys if they are needed.
     */
